...
// TODO: Check depcrecation of getNodes
...
const HIGHLIGHT_COLOR = '#FA5F28'

const SNAP_HIGHLIGHT_COLOR = 'red'
      ...
      (res, n) => {
        ...
        if (n.id !== connectionStartHandle.value?.nodeId) {
          ...
          if (d < res.distance && d < MIN_DISTANCE) {
            ...
            // TODO: SHOULD HIGHLIGHT THE SHORTEST, BUT IS NOT DOING THIS
            res.distance = d
            res.node = n
          }
        }
...
<template>
  <g>
    ...
    <circle :cx="targetX" :cy="targetY" fill="transparent" :stroke="strokeColor" :r="10" :stroke-width="3" />
  </g>
</template>